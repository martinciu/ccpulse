...
func TestFormatBarValue(t *testing.T) {
	tests := []struct {
		...
		// cost — cents below $1, whole dollars + separators to <$1M,
		// 3-sig-fig M/G safety net above.
		{"cost zero", 0, chartUnitCost, "$0"},
		{"cost negative", -5, chartUnitCost, "$0"},
		{"cost sub-cent", 0.004, chartUnitCost, "$0.00"},
		{"cost cents 0.04", 0.04, chartUnitCost, "$0.04"},
		{"cost cents 0.45", 0.45, chartUnitCost, "$0.45"},
		{"cost cents 0.40 keeps trailing zero", 0.40, chartUnitCost, "$0.40"},
		{"cost one dollar", 1, chartUnitCost, "$1"},
		{"cost 45", 45, chartUnitCost, "$45"},
		{"cost 999", 999, chartUnitCost, "$999"},
		{"cost 1000 separators", 1000, chartUnitCost, "$1,000"},
		{"cost 1200 exact", 1200, chartUnitCost, "$1,200"},
		{"cost 1800 exact", 1800, chartUnitCost, "$1,800"},
		{"cost rounds to dollar", 1234.56, chartUnitCost, "$1,235"},
		{"cost 12340", 12340, chartUnitCost, "$12,340"},
		{"cost 123400", 123400, chartUnitCost, "$123,400"},
		{"cost just below M", 999999, chartUnitCost, "$999,999"},
		{"cost rounds up into M band", 999999.6, chartUnitCost, "$1M"},
		{"cost exactly 1M", 1_000_000, chartUnitCost, "$1M"},
		{"cost 1.23M", 1_230_000, chartUnitCost, "$1.23M"},
		{"cost 1G", 1_000_000_000, chartUnitCost, "$1G"},

		// tokens — full integer + separators to <1M, 3-sig-fig M/G above.
		{"tok zero", 0, chartUnitTokens, "0"},
		{"tok 42", 42, chartUnitTokens, "42"},
		{"tok 750", 750, chartUnitTokens, "750"},
		{"tok 999", 999, chartUnitTokens, "999"},
		{"tok 1000 separators", 1000, chartUnitTokens, "1,000"},
		{"tok 5000", 5000, chartUnitTokens, "5,000"},
		{"tok 12340", 12340, chartUnitTokens, "12,340"},
		{"tok 750000", 750_000, chartUnitTokens, "750,000"},
		{"tok 999500 stays full below M", 999_500, chartUnitTokens, "999,500"},
		{"tok just below M", 999_999, chartUnitTokens, "999,999"},
		{"tok exactly 1M", 1_000_000, chartUnitTokens, "1M"},
		{"tok 1.2M trims", 1_200_000, chartUnitTokens, "1.2M"},
		{"tok 1.23M", 1_230_000, chartUnitTokens, "1.23M"},
		{"tok 12.3M", 12_300_000, chartUnitTokens, "12.3M"},
		{"tok 123M", 123_000_000, chartUnitTokens, "123M"},
		{"tok 999.6M carries to 1G", 999_600_000, chartUnitTokens, "1G"},
		{"tok 1.2G", 1_200_000_000, chartUnitTokens, "1.2G"},
		{"tok 1.23G", 1_230_000_000, chartUnitTokens, "1.23G"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
